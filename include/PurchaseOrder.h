...
public:
    PurchaseOrder();
    PurchaseOrder(string sequentialOrderNumber, string secondaryOrderID, string priorityTime, string priorityIndicator, string orderPrice, string totalQuantityOfOrder, string tradedQuantityOfOrder, int orderSource);
